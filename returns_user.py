...
CTkLabel(master= main_view, text = """Thanks for returning your book.
         submit feedback if you need to:""", font = ("Arial Bold", 25), text_color= "#207244").pack(anchor = "nw", pady= (20, 0), padx = 24)
