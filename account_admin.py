...
CTkButton(master=main_view, image=account_person_img, text="Admin", fg_color="#207244", font=("Arial Bold", 14), width=150, height=70).pack(anchor="nw", pady=(29, 0), padx=10)
